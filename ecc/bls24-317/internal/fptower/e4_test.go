...
func TestE4Ops(t *testing.T) {
	...
	properties.Property("[BLS24-317] BatchInvertE4 should output the same result as Inverse", prop.ForAll(
		func(a, b, c *E4) bool {
	...
	properties.Property("[BLS24-317] Frobenius of x in E4 should be equal to x^q", prop.ForAll(
		func(a *E4) bool {
			var b, c E4
			q := fp.Modulus()
			b.Frobenius(a)
